...
out_ = cv2.VideoWriter('outpy_testing.avi', cv2.VideoWriter_fourcc('M', 'J', 'P', 'G'), 1, (1200, 678))
...
w = None
previous_obj_ids =[]
rtsp="http://admin:gi@12345@182.76.41.11:80/ISAPI/Streaming/channels/101/picture?snapShotImageType=JPEG&videoResolutionWidth=1920&videoResolutionHeight=1080"
cap.open(rtsp)
frame_count=0
process_frame = 20
while True:
    
    #cap.open("http://admin:gi@12345@182.76.41.11:80/ISAPI/Streaming/channels/101/picture?snapShotImageType=JPEG&videoResolutionWidth=1920&videoResolutionHeight=1080")
